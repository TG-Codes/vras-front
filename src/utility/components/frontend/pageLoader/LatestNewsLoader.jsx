    ...
    <section className="news_blog">
        <div className="container">
            <div className="common_txt text-center">
                <h2 className="placeholder">Recent News</h2>
            </div>
            <div className="trainning_price_innr">
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="blog_box">
                            <figure className="placeholder" style={{backgroundColor: "#fff", width: "100%"}}>
                            </figure>
                            <ul>
                                <li><a href="javascript:void(0);" className="placeholder">Creative</a></li>
                                <li><a href="javascript:void(0);" className="placeholder">Technology</a></li>
                            </ul>
                            <h2><a href="javascript:void(0);" className="placeholder">Lorem Ipsum is simply dummy</a></h2>
                            <p className="placeholder">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum </p>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="blog_box">
                ...
                <div className="load_more_holder text-center">
                    <a className="black_btn placeholder" href="javascript:void(0)" style={{width: "225px", height: "60px", backgroundColor: "#fff"}}></a>
                </div>
            </div>
        </div>
    </section>
