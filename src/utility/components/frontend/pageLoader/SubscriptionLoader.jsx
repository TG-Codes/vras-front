    ...
    <div>
         {/* <header className="header_wrapper ">
            <div className="container hdr_container">
               <a className="navbar-brand logo placeholder" href="index.html" style="min-height: 65px;background-color: #bababa;">
               </a>
    ...
    <section className="trainning_price_sec">
        <div className="container">
            <div className="common_txt text-center">
                <h2 className="placeholder">Our Exclusive Packages</h2>
            </div>
            <div className="trainning_price_innr">
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="trainning_price_box">
                            <h2 className="placeholder" style={{width: "100%", height: "105px"}}></h2>
                            <div className="pricing_area_outer placeholder" style={{backgroundColor: "#fff"}}>
                               
                            </div>
                            <p className="placeholder">Lorem Ipsum has been the industry's standard dummy text</p>
                            <a href="javascript:void(0);" className="black_btn placeholder" style={{width: "225px", height:"64px", backgroundColor: "#fff"}}></a>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="trainning_price_box">
                ...
                <div className="load_more_holder text-center">
                    <a className="black_btn placeholder" href="javascript:void(0)" style={{width: "250px", height: "64px", backgroundColor: "#fff"}}></a>
                </div>
            </div>
        </div>
    </section>
                 ...
                 <div className="col-lg-3 col-md-5">
                    <div className="ftr_list">
                       ...
                       <div className="ftr_news_form">
                          <form>
                             <input type="text" className="form-control placeholder" placeholder=""  style="background-color: #fff"/>
