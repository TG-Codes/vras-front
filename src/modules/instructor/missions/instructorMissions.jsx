...
const InstructorMissions = (props) => {
  ...
  const [components, setcomponents] = useState({
    ...
    const [columnDefs, setColumnDefs] = useState([
      ...
      { field: "description", width: "370" },
      { field: "location", width: "300" },
      { field: "difficulty", width: "350" },
      { field: "health", width: "350" },
      { field: "notes", width: "350" },
    //   {
    //     field: "Action",
    //     cellRenderer: (params) => {
    //       if (params.data) {
    ...
    const datasource = {
        getRows(params) {
          let url = `${baseUrL}/instructors/missions?`;
    ...
    const onGridReady = useCallback((params) => {
      ...
      const onRowClicked = (event)=> {
        navigate(`/instructor/mission-details/${event.data.id}`)
      }
  return (
...
export default connect(mapStateToProps,{})(InstructorMissions)
