...
// const InstructorMissionDetails = () => {
//   return (
//     <div>
...
// export default InstructorMissionDetails
...
const InstructorMissionDetails = (props) => {
...
const paramsData = useParams()
  ...
  const datasource = {
    getRows(params) {
      let url = `${baseUrL}/instructors/missions/${paramsData?.slug}?`;
      ...
      try {
        ...
        response
          .then((response) => {
            console.log("response.data.data ", response.data.data.userMissions)
            params.successCallback(
              response.data.data.userMissions,
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { field: "assaultTime" },
    { field: "bulletsFired" },
    { field: "bulletsOnCrowd" },
    { field: "bulletsOnTerrorist" },
    { field: "casualities" },
    { field: "confirmedKills" },
    { field: "feedback" },
    { field: "mode" },
    { field: "playersDamage" },
    { field: "responseTime" },
...
export default connect(mapStateToProps,{})(InstructorMissionDetails)
